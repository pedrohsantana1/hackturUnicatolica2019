...
class ViewModelHome(application: Application):AndroidViewModel(application) {
    private val listaHome = arrayListOf(
        ModelListaHome(
            R.drawable.praiagraciosa,"Praia da Graciosa", "Melhor por do sol", "Praia","Porta de entrada da Capital, a Graciosa é a principal praia da cidade., banheiros, playground, marina com atracadouro, píer e vista para a Ponte da Amizade. " +
                    "estrutura conta com 1200 metros de ciclovia e 500 metros de pista de cooper que abrange toda a orla"),
        ModelListaHome(
            R.drawable.arnos,"Praia das Arnos","Praia na região norte", "Praia","Uma ótima opção de lazer para os moradores da região Norte da Capital, a Praia das Arnos está localizada a aproximadamente três quilômetros do Palácio Araguaia. Com uma área de 8.764 m² e dotada de bares e restaurantes de pequeno porte, a praia é hoje referência em beleza na Capital e vem atraindo cada vez mais banhistas. Possui banheiros com duchas, quiosques," +
                    " quadra de esportes, estacionamento, dentre outros equipamentos."),
        ModelListaHome(
            R.drawable.centro,"Centro Geodésico","Centro do Brasil", "Praça","O Centro Geodésico do Brasil fica no hall de entrada do Palácio Araguaia e é marcado pela Rosa dos Ventos. É o ponto central entre os extremos do nosso país (norte-sul, leste-oeste). Entretanto, para dar maior destaque ao monumento, foi criada a Roda dos Ventos em tamanho maior, do lado de fora " +
                    "do Palácio Araguaia"),
    ...
    fun getPlanoSearch(string: String, listaPlano:List<ModelListaHome>):ArrayList<ModelListaHome> {
